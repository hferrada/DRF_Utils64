...
Make:
	...
	create the lib: 'drflib64.a'.

Compile:
	To use the library you must compile your program linking 'drflib64.a' and include
	the the header that you nedd in your sorce code. For example "includes/RMQRMM64.h" to 
	buil RMQ compressed structures.
	For example, compiling the file test.cpp included here:
		g++ test.cpp -o myRMQlib -O3 drflib64.a 
		or simply run the command 'make test'. it will create the binary 'myRMQlib'.
